...
class AttentionModel:
    def __init__(self, model_path=None):
        if model_path:
            ...
            self.model = attention_model_masking()
    ...
    def load_data(self, data=None):
        ...
        if data:
            ...
            train_data = None
            dev_data = None
        train_contexts = get_contexts(train_data)   # [word_indices, context_features, pos_tags, entity_tags, masks] 
        train_questions = get_questions(train_data) # [word_indices, masks]
        ...
        #
        dev_contexts = get_contexts(dev_data, is_train=False)    # [word_indices, context_features, pos_tags, entity_tags, masks]
